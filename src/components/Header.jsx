          ...
          >
            ...
            <nav className="mt-6">
              <ul className="-my-2 divide-y divide-zinc-100 text-base text-zinc-800 dark:divide-zinc-100/5 dark:text-zinc-300">
                ...
                <MobileNavItem href="/a-propos">A propos</MobileNavItem>
                <MobileNavItem href="/realisations">Réalisations</MobileNavItem>
  ...
  return (
    ...
    >
      <Image
        ...
        className={clsx(
          'rounded-full border-2 border-zinc-400 bg-zinc-100 object-cover dark:bg-zinc-800',
